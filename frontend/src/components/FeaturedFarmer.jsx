  ...
  return (
    <section className="mb-12">
      ...
      <div className="flex items-center gap-2 mb-8 px-2">
        ...
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">{t('Meet the Producer of the Week', 'Γνωρίστε τον Παραγωγό της Εβδομάδας')}</h2>
      </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          {products.length > 0 && (
            <div className="flex items-center gap-3">
              <span className="text-sm text-gray-500 dark:text-gray-400">{t('Products:', 'Προϊόντα:')}</span>
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            ...
            >
              ...
              {t('Read Full Story', 'Διαβάστε την Ιστορία')}
            </Link>
            ...
            >
              {t('View Products', 'Προβολή Προϊόντων')}
